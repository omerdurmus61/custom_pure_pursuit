...
bool
autoware_planning_msgs__msg__Path__are_equal(const autoware_planning_msgs__msg__Path * lhs, const autoware_planning_msgs__msg__Path * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // points
  if (!autoware_planning_msgs__msg__PathPoint__Sequence__are_equal(
...
bool
autoware_planning_msgs__msg__Path__copy(
  const autoware_planning_msgs__msg__Path * input,
  autoware_planning_msgs__msg__Path * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // points
  if (!autoware_planning_msgs__msg__PathPoint__Sequence__copy(
...
autoware_planning_msgs__msg__Path__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_planning_msgs__msg__Path * msg = (autoware_planning_msgs__msg__Path *)allocator.allocate(sizeof(autoware_planning_msgs__msg__Path), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_planning_msgs__msg__Path__Sequence__init(autoware_planning_msgs__msg__Path__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_planning_msgs__msg__Path *)allocator.zero_allocate(size, sizeof(autoware_planning_msgs__msg__Path), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_planning_msgs__msg__Path__Sequence * array = (autoware_planning_msgs__msg__Path__Sequence *)allocator.allocate(sizeof(autoware_planning_msgs__msg__Path__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
autoware_planning_msgs__msg__Path__Sequence__are_equal(const autoware_planning_msgs__msg__Path__Sequence * lhs, const autoware_planning_msgs__msg__Path__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_planning_msgs__msg__Path__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_planning_msgs__msg__Path__Sequence__copy(
  const autoware_planning_msgs__msg__Path__Sequence * input,
  autoware_planning_msgs__msg__Path__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_planning_msgs__msg__Path);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_planning_msgs__msg__Path * data =
      (autoware_planning_msgs__msg__Path *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_planning_msgs__msg__Path__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_planning_msgs__msg__Path__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_planning_msgs__msg__Path__copy(
