...
#include "autoware_planning_msgs/msg/detail/path_point__type_support.h"
...
static const _PathPoint_type_support_symbol_names_t _PathPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_planning_msgs, msg, PathPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, PathPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_planning_msgs, msg, PathPoint)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_c::PathPoint_message_type_support_handle;
}
