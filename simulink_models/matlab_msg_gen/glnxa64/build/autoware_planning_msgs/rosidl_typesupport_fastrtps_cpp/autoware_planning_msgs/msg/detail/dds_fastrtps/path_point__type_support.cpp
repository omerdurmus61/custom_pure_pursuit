...
#include "autoware_planning_msgs/msg/detail/path_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_planning_msgs::msg::PathPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_planning_msgs::msg::PathPoint & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_planning_msgs::msg::PathPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_planning_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_planning_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  return &autoware_planning_msgs::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_planning_msgs, msg, PathPoint)() {
  return &autoware_planning_msgs::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
