...
{
  const auto & item = *reinterpret_cast<const autoware_planning_msgs::msg::PathPoint *>(
    get_const_function__Path__points(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_planning_msgs::msg::PathPoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_planning_msgs::msg::PathPoint *>(
    get_function__Path__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_planning_msgs::msg::PathPoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Path_message_member_array[4] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::Path, left_bound),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::Path, right_bound),  // bytes offset in struct
    nullptr,  // default value
