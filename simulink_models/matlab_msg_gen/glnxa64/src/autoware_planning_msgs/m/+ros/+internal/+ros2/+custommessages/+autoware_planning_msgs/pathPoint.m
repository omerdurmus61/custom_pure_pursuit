...
%PathPoint gives an empty data for autoware_planning_msgs/PathPoint
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'autoware_planning_msgs/PathPoint';
...
info.MessageType = 'autoware_planning_msgs/PathPoint';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
