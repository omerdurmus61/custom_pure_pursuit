...
// Common copy functions for autoware_planning_msgs/PathPoint
#ifdef _MSC_VER
#pragma warning(push)
...
class AUTOWARE_PLANNING_MSGS_EXPORT ros2_autoware_planning_msgs_msg_PathPoint_common : public MATLABROS2MsgInterface<autoware_planning_msgs::msg::PathPoint> {
  public:
    virtual ~ros2_autoware_planning_msgs_msg_PathPoint_common(){}
    virtual void copy_from_struct(autoware_planning_msgs::msg::PathPoint* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const autoware_planning_msgs::msg::PathPoint* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_autoware_planning_msgs_msg_PathPoint_common::copy_from_struct(autoware_planning_msgs::msg::PathPoint* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_autoware_planning_msgs_msg_PathPoint_common::get_arr(MDFactory_T& factory, const autoware_planning_msgs::msg::PathPoint* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("autoware_planning_msgs/PathPoint");
    // pose
...
class AUTOWARE_PLANNING_MSGS_EXPORT ros2_autoware_planning_msgs_PathPoint_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_autoware_planning_msgs_PathPoint_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_autoware_planning_msgs_PathPoint_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<autoware_planning_msgs::msg::PathPoint,ros2_autoware_planning_msgs_msg_PathPoint_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_autoware_planning_msgs_PathPoint_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<autoware_planning_msgs::msg::PathPoint,ros2_autoware_planning_msgs_msg_PathPoint_common>>();
  }
  std::shared_ptr<void> ros2_autoware_planning_msgs_PathPoint_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<autoware_planning_msgs::msg::PathPoint>();
    ros2_autoware_planning_msgs_msg_PathPoint_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_autoware_planning_msgs_PathPoint_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_autoware_planning_msgs_msg_PathPoint_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (autoware_planning_msgs::msg::PathPoint*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_autoware_planning_msgs_msg_PathPoint_common, MATLABROS2MsgInterface<autoware_planning_msgs::msg::PathPoint>)
CLASS_LOADER_REGISTER_CLASS(ros2_autoware_planning_msgs_PathPoint_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
